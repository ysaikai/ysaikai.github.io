...
| 3 | [Root finding](/files/root_finding.html){:target="_blank"} |
| 4 | [Optimisation](/files/optimisation.html){:target="_blank"} |
| 5 | [Numerical integration](/files/numerical_integration.html){:target="_blank"} |
| 6 | [Ordinary differential equations](/files/differential_equation.html){:target="_blank"} |
